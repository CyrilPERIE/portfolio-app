  ...
  projects: [
    {
      ...
      content: "Très actif dans mon temps sur tout type de projet personnel, j'ai trouvé qu'il manqué d'un plateforme sur laquelle présenter ses projets pour trouver des partenaires et monter une équipe. Et inversement, trouver un projet à rejoindre.",
