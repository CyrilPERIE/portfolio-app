...
export const state: stateModel = {
  ...
  projects: [
    ...
    {
      url_git: "https://gitlab.com/project-collab",
      ...
      alt: "project-collab",
      skills: [Python, Fast, Figma, React, Vercel, SQLAlchemy],
    },
    {
      url_git: "https://github.com/CyrilPERIE/portfolio-app",
      url_web: "https://cyrilperie.vercel.app/",
    ...
    {
      url_git: "https://github.com/CyrilPERIE/images",
